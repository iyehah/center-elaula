...
from nonpay import ClassNonPay
...
class ReportsTab(ctk.CTkFrame):
    def __init__(self, root):
        ...
        self.payment_report.grid(row=0, column=1, padx=10, pady=10, sticky="e")  # Right side
         # Creating the PaymentReport instance (Payment Report)
        self.payment_report = ClassNonPay(self.center_frame) 
        self.payment_report.grid(row=1, column=0, padx=10, pady=10, sticky="e")  # Right side
        ...
        self.cotisations_report.grid(row=1, column=1, padx=10, pady=10, sticky="e")  # Spans across both columns
        
        # Creating the CotisationsRaport instance (Teacher Contributions Report)
        self.financial_report = FinancialReport(self.center_frame)
        self.financial_report.grid(row=2, column=0, padx=10, pady=10, sticky="e")  # Spans across both columns
